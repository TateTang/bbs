		...
		<c:forEach items="${helpList }" var="help">
			<tr>
				<td width="110px" height="30px" style="font-size: 14px;"><div
						...
						<a
							href="help_getAll.action?helpId=${help.id }"
							target="_top">${help.title } </a>
					</div>
				</td>
				<td width="90px" style="font-size: 9px;">
					<fmt:formatDate value="${help.newtime }" type="date" pattern="MM-dd HH:mm"/>
				</td>
			</tr>
		</c:forEach>
	</table>
